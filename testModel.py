...
modelFileName="./trainingDone/1/MaxACCModel.tar"
...
while(i<400):
    ...
    while(j<200):
        ...
        for point in gridCell:
            ...
            newPoint=point[0] + " " + point[1]+ " " + point[2] + " " + "0 "  + "255 "+"0 "  + "\n"
...
for unusedPoint in inputClass.unusedPoints:
    ...
    newPoint=unusedPoint[0] + " " + unusedPoint[1]+ " " + unusedPoint[2] + " " + "120 "  + "150 "+"100 "+ "\n"
    newPoints.append(newPoint)
