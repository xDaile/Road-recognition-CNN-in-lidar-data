    ...
    def getGTintoPoints(self):
        ...
        while(i<400):
            while(j<200):
                ...
                newPoints=[str(str(x)+" "+ str(y)+" "+str(0)+" "+str(0)+" "+str(self.gt[i][j])+" "+str(1))+" 0\n"]
...
def main():
    ...
    #create only one rotated file
    dataset.itemsList=('./pclFiles/umm_000076.poinCL', './GroundTruth/uu_000076_gt.npy')
    buildRotator()
    multiprocessFunction(dataset.itemsList)
